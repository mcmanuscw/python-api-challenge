Please find the weather py code within the Weather Py folder. My thanks to K Cooper for helping me with the try/except logic for processing.
...
Python API project repository

#### For the unit 6 homework, we will be using the Python API skills we learned to gather and present data that proves what happens when you travel closer to the equator.

### These steps begin the project.
